...
spa.avatar = (function () {
    ...
    updateAvatar = function ($target) {
        ...
        css_map = {
            ...
            'background-color' : $target.css('baclground-color')
        };
        
        person_id = $target.attr('data-id');
        
        configMap.chat_model.update_avatar({ person_id : person_id, css_map : css_map });
    };
    ...
    onHeldendNav = function (event) {
        ...
        $drag_target.removeClass('spa-x-is-drag').css('baclground-color', stateMap.drag_bg_color);
    ...
    onSetchatee = function (event, arg_map) {
        ...
        if (old_chatee) {
            $nav
                .find('.spa-avatar-box[data-id=' + old_chatee.cid + ']')
                .removeClass('spa-x-is-chatee');
        }
        
        if (new_chatee) {
            $nav
                .find('.spa-avatar-box[data-id=' + new_chatee.cid + ']')
